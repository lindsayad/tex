...
\textbf{Computational Scientist}, \textit{Idaho National Laboratory}, \textsc{2017 - Present}\newline
\hspace*{0.5em}Multiphysics Object-Oriented Simulation Environment (MOOSE) framework lead\newline
\hspace*{0.5em}Research topics:
  \begin{itemize}
  \item Discontinuous Galerkin, continuous Galerkin, and finite volume methods for incompressible, weakly compressible, and fully compressible fluid flows
  \item Scalable block preconditioning of saddle-point problems
  \item Mortar finite element methods
  \item Automatic differentiation
  \item Aribitrary Lagrangian-Eulerian framework for fluid-structure interaction and melt pool applications
  \end{itemize}
...
\begin{table}[H]
\begin{tabular}{rl}
  \textsc{2025} & Presidential Early Career Award for Scientists and Engineers (PECASE) \\
...
\item \href{https://gitlab.com/slepc/slepc}{SLEPc} scalable solution of sparse
  eigenvalue problems
\item \href{https://mooseframework.inl.gov/TMAP8/index.html}{TMAP8} tritium migration analysis program

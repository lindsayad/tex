...
\begin{itemize}
\item Google Scholar total number of citations: 2484
\item h-index: 19
\item i10-index: 31
\end{itemize}

\begin{enumerate}
  \item Hu, Rui, Ling Zou, Daniel O’Grady, Travis Mui, Zhiee Jhia Ooi, Guojun Hu, Eric Cervi et al. "SAM: A Modern System Code for Advanced Non-LWR Safety Analysis." Nuclear Technology 211, no. 9 (2025): 1883-1902.
  \item Harbour, Logan, Guillaume Giudicelli, Alexander D. Lindsay, Peter German, Joshua Hansel, Casey Icenhour, Mengnan Li et al. "4.0 MOOSE: Enabling massively parallel Multiphysics simulation." SoftwareX 31 (2025): 102264.
  \item Giudicelli, Guillaume L., Fande Kong, Roy Stogner, Logan Harbour, Derek Gaston, Alexander Lindsay, Zachary Prince et al. "Data transfers for nuclear reactor multiphysics studies using the MOOSE framework." Frontiers in Nuclear Engineering 4 (2025): 1611173.
  \item Simon, P. C. A., Icenhour, C. T., Singh, G., Lindsay, A. D., Bhave, C., Yang, L., Riet, A., Che, Y., Humrickhouse, P., Calderoni, P., \& Shimada, M. (2025). MOOSE-based Tritium Migration Analysis Program, Version 8 (TMAP8) for advanced open-source tritium transport and fuel cycle modeling. Fusion Engineering and Design, 214, Article 114874. Advance online publication. https://doi.org/10.1016/j.fusengdes.2025.114874
  \item Giudicelli, G., Green, C., Hansel, J., Andrs, D., Novak, A., Schunert,
    S., ... \& Lindsay, A. (2024). The MOOSE fluid properties module. Computer
    Physics Communications, 109407.
  \item Hu, R., Zou, L., O’Grady, D., Mui, T., Ooi, Z.J., Hu, G., Cervi, E.,
    Yang, G., Andrs, D., Lindsay, A. and Permann, C., 2024. SAM: A Modern
    System Code for Advanced Non-LWR Safety Analysis. Nuclear Technology,
    pp.1-20.
  \item Recuero, A. M., Gamble, K. A., Yushu, D., \& Lindsay,
    A. D. (2024). Multidimensional modeling of fuel-cladding friction in an
    LWR fuel rod. Nuclear Engineering and Design, 424, 113291.
  \item Giudicelli, Guillaume, Alexander Lindsay, Logan Harbour, Casey Icenhour,
    Mengnan Li, Joshua E. Hansel, Peter German et al. "3.0-MOOSE: Enabling
    massively parallel multiphysics simulations." SoftwareX 26 (2024): 101690.
  \item Icenhour, C. T., Lindsay, A. D., Permann, C. J., Martineau, R. C.,
    Green, D. L., \& Shannon, S. C. (2024). The MOOSE electromagnetics
    module. SoftwareX, 25, 101621.
  ...
  \item Simon, P. C. A., Humrickhouse, P. W., \& Lindsay, A. D. (2022). Tritium transport modeling at the pore scale in ceramic breeder materials using TMAP8. IEEE Transactions on Plasma Science, 50(11), 4465-4471.
